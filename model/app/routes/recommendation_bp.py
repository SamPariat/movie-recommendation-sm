...
@recommendation_blueprint.route('/movie-prediction', methods=['GET'])
def movie_prediction():
    try:
        ...
        cos_similarity_pkl_path = os.path.join(
            script_dir, '../../cos_similarity.pkl')
...
@recommendation_blueprint.route('/all-movies', methods=['GET'])
def all_movies():
    try:
